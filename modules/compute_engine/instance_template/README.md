...
| <a name="input_threads_per_core"></a> [threads\_per\_core](#input\_threads\_per\_core) | The number of threads per physical core. To disable simultaneous multithreading (SMT) set this to 1. | `any` | `null` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_template_name"></a> [template\_name](#output\_template\_name) | Name of instance template |
| <a name="output_template_self_link"></a> [template\_self\_link](#output\_template\_self\_link) | Self-link of instance template |
| <a name="output_template_tags"></a> [template\_tags](#output\_template\_tags) | Tags that will be associated with instance(s) |
<!-- END_TF_DOCS -->