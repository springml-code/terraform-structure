...
variable "image_version" {
  type        = string
  description = "The version of the aiflow running in the cloud composer environment. https://cloud.google.com/composer/docs/concepts/versioning/composer-versions"
  default     = "composer-2.0.28-airflow-2.2.5"
}
